...
/**
 * Provides a trusted callback to alter the OpenEuropa language switcher.
 *
 * @see oe_multilingual_block_view_oe_theme_helper_page_header_alter()
 */
class LanguageSwitcherBuilder implements TrustedCallbackInterface {
